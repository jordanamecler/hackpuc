...
//        self.view.addSubview(userLabel)
        ...
        userTextField.frame = CGRectMake(0, logoImage.frame.origin.y + logoImage.frame.height + 110, self.view.frame.width/2, 30)
        userTextField.center.x = view.center.x
...
//        
        passwordTextField.frame = CGRectMake(userTextField.frame.origin.x, userTextField.frame.origin.y + userTextField.frame.height + 8, self.view.frame.width/2, 30)
        ...
        fbLoginButton.frame.origin = CGPointMake(0, passwordTextField.frame.origin.y + passwordTextField.frame.height + 120)
        fbLoginButton.center.x = self.view.center.x
        
        self.view.addSubview(fbLoginButton)
        
        loginButton.frame = CGRectMake(0, passwordTextField.frame.origin.y + passwordTextField.frame.height + 30, fbLoginButton.frame.width, fbLoginButton.frame.height)
